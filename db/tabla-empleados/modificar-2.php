...
cabecera("empleados - Modificar 2", MENU_empleados, PROFUNDIDAD_2);
...
if ($id == "") {
    ...
    $consulta = "SELECT * FROM $cfg[dbempleadosTabla]
                 WHERE id = :id";
    ...
    if (!$resultado) {
        ...
        print "            <td><input type=\"text\" name=\"telefono\" size=\"$cfg[formempleadosTamTelefono]\" maxlength=\"$cfg[formempleadosTamTelefono]\" value=\"$registro[telefono]\"></td>\n";
        print "          </tr>\n";
        print "          <tr>\n";
        print "            <td>Correo:</td>\n";
        print "            <td><input type=\"text\" name=\"correo\" size=\"$cfg[formempleadosTamCorreo]\" maxlength=\"$cfg[formempleadosTamCorreo]\" value=\"$registro[correo]\"></td>\n";
        print "          </tr>\n";
        print "          <tr>\n";
        print "            <td>RFID:</td>\n";
